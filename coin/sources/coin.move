module coin::coin {
    ...
    public fun mintCoinObject(cap: &mut coin::TreasuryCap<COIN>, amount: u64, ctx: &mut TxContext){
        let coin_object = coin::mint(cap, amount, ctx);
        transfer::public_transfer(coin_object, ctx.sender());
    }

    public fun burnCoinObject(cap: &mut coin::TreasuryCap<COIN>, coin_object: coin::Coin<COIN>) {
